...
export const en = {
  ...
  freeSignals: {
    ...
    metaDescription: "Free daily AI-generated forex, index and commodity signals on Telegram. Every idea carries entry, stop and target. Educational content from NUUK's algorithmic trading desk, not investment advice.",
    brandLine: "NUUK AI · Free Forex Signals & Algo Trading",
    kicker: "Free signals",
    title: "Free daily AI forex signals for better-informed trading",
    lead: "Currency pairs, indices and commodities, scanned by NUUK's algorithmic systems and published free on Telegram. Every idea carries its entry, target and stop so you can judge it against your own plan.",
    cta: { label: "Join the free channel", href: "https://t.me/NUUKQuant" },
    ...
    chatLink: "Join our Telegram community",
    ...
    aboutLead: "NUUK is an AI-engineered trading company in Dubai's DIFC, built on seventeen years of Istanbul and London dealing-desk experience. We explain how the forex market works through plain, usable analysis and run every strategy on our own capital first.",
    ...
    faq: [
      ...
      { q: "How do I start trading forex?", a: "Learn how the market works first, then practise on a demo account before committing real money. Along the way you can join our free Telegram community to follow the daily signals and market commentary." },
    ...
    closingBody: "Join the free NUUK Telegram channel and follow the AI signals with the reasoning attached.",
