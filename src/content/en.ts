...
export const en = {
  ...
  brand: {
    ...
    whatsappChannel: "https://whatsapp.com/channel/0029Vb8niap8PgsAy0E3tp2b",
  ...
  nav: [
    {
      ...
      items: [
        ...
        { label: "Free AI signals", href: "/free-signals/" },
      ],
    },
  ...
  brokers: {
    ...
    list: [
      ...
      },
      {
        ...
        referralHref: "https://tickmill.link/4ah0sEO",
        steps: ["Register: fill in name, country, client type and email at my.tickmill.com/sign-up to create your Client Area; if the Introducing Broker field is empty, enter IB code IB82498200", "Verify: log in to the Client Area and upload proof of identity and proof of address", "Create account: once documents are approved, open a live account choosing Classic, Raw or TradingView Raw, base currency (USD/EUR/GBP/ZAR) and leverage", "Deposit: select a payment method (bank wire, card, Skrill, Neteller, UnionPay, crypto) and fund from $100; most methods credit instantly", "Trade: download MT4/MT5, Tickmill Trader or connect TradingView with your account credentials and start trading"],
        status: "live",
  ...
  freeSignals: {
    metaTitle: "NUUK AI Free Forex Signals & Algo Trading",
    metaDescription: "Free daily AI-generated forex, index and commodity signals on our WhatsApp channel. Every idea carries entry, stop and target. Educational content from NUUK's algorithmic trading desk, not investment advice.",
    brandLine: "NUUK AI · Free Forex Signals & Algo Trading",
    kicker: "Free signals",
    title: "Free daily AI forex signals for better-informed trading",
    lead: "Currency pairs, indices and commodities, scanned by NUUK's algorithmic systems and published free on our WhatsApp channel. Every idea carries its entry, target and stop so you can judge it against your own plan.",
    cta: { label: "Join the free channel", href: "https://whatsapp.com/channel/0029Vb8niap8PgsAy0E3tp2b" },
    secondary: { label: "How the algorithms work", href: "/ai-trading/" },
    instruments: [
      { code: "EUR", name: "EUR/USD" },
      { code: "USD", name: "US Dollar" },
      { code: "XAU", name: "Gold" },
      { code: "OIL", name: "Brent / WTI" },
      { code: "GBP", name: "GBP/USD" },
    ],
    startTitle: "Getting started",
    chatTitle: "Chat with us",
    chatLink: "Join our WhatsApp channel",
    chatBody: "Our channels are free and run for educational purposes. We share market analysis and signals so that members learn from them; nothing in the channel is investment advice.",
    chatCta: "Join the free channel",
    dailyTitle: "What arrives each day",
    daily: [
      "A short morning note: what matters today and the key levels",
      "Signals with entry, target and stop in one message",
      "A one-line reason for every idea, so you learn the logic",
      "The result of every closed idea, win or loss",
    ],
    riskLine: "Forex and CFD trading carries a serious risk of loss and is not suitable for every investor. Past performance is not an indicator of future results.",
    accessTitle: "Access free daily forex signals",
    accessBody1: "Receive free forex signals every day to support your own market analysis. They cover currency pairs, indices and commodities, and their purpose is to help you follow market moves more closely.",
    accessBody2: "Join NUUK to follow the daily signals and market commentary produced by our algorithmic systems and reviewed by the desk. The signals shared are for information only and do not constitute investment advice.",
    accessCta: "Join the free channel",
    sampleLabel: "Illustrative examples of the message format, not live signals",
    labels: { entry: "Entry", target: "Target", stop: "Stop", rr: "R:R" },
    samples: [
      { instrument: "EUR/USD", direction: "Buy", entry: "1.1720", target: "1.1790", stop: "1.1675", rr: "1:1.6", note: "Bounce from the weekly demand zone while the dollar index stalls under resistance." },
      { instrument: "XAU/USD", direction: "Buy", entry: "4,392", target: "4,464", stop: "4,368", rr: "1:3", note: "Gold held the 4,380–4,400 zone after payrolls; real yields failed to make a new high." },
      { instrument: "US100", direction: "Buy", entry: "24,150", target: "24,600", stop: "23,900", rr: "1:1.8", note: "Trend continuation above the 20-day average with breadth improving into the open." },
    ],
    howTitle: "How NUUK AI produces a signal",
    howLead: "The same pipeline that runs our own algorithmic trading systems produces the free ideas. Nothing is hand-picked after the fact.",
    how: [
      { title: "Data", body: "Price, volume, volatility and the economic calendar for 40+ instruments, refreshed continuously." },
      { title: "Models", body: "Trend, mean-reversion and event models score each instrument and agree on a direction, or stay flat." },
      ...
      { title: "Published", body: "Ideas that pass are posted to our WhatsApp channel with entry, target, stop and one line of reasoning. Results are logged when they close." },
    ],
    ...
    aim: [
      ...
      "Most people never step into the forex market because they do not know where to start. We are here to change that: daily AI signals, market analysis and a supportive community open to traders at every level.",
      "We do not give investment advice and we promise no one a result. What we offer is education, daily market analysis and a community that stands beside you while you build your own risk management and your own trading discipline.",
      "With an average daily turnover of around 9.6 trillion dollars, forex is the largest and most liquid financial market in the world. Join the community and start learning today.",
    ],
    aboutTitle: "About NUUK",
    aboutLead: "NUUK is an AI-engineered trading company in Dubai's DIFC, built on seventeen years of Istanbul and London dealing-desk experience. We explain how the forex market works through plain, usable analysis and test every strategy on a model portfolio before it goes live.",
    servicesTitle: "What we offer",
    services: ["AI-generated signals for forex, indices and commodities", "Systematic algo trading systems with a published track record", "Guidance for reading market trends and managing risk"],
    aboutClose: "We do not believe in shortcuts; we believe in discipline, risk management and a patient learning process. Our aim is to give you the knowledge and the community you need to make your own informed decisions in the forex market.",
    aboutCta: { label: "See the track record", href: "/track-record/" },
    faqTitle: "Frequently asked questions",
    faq: [
      { q: "What is forex?", a: "Forex is the global market where currency pairs are bought and sold. Traders aim to benefit from moves in exchange rates. As with every kind of trading, there is a risk of loss." },
      { q: "How does the forex market work?", a: "Every trade is a pair: one currency is bought while the other is sold. Alongside pairs such as EUR/USD, metals like gold and silver and stock indices trade on the same logic. The market is open 24 hours a day on weekdays." },
      { q: "Which are the major currency pairs?", a: "The most traded pairs are EUR/USD, USD/JPY, GBP/USD, USD/CHF, AUD/USD and USD/CAD. They are called the majors; because their volume is high, their spreads are usually lower." },
      { q: "What moves forex prices?", a: "Prices react to economic data such as interest-rate decisions, inflation and growth figures, to central-bank statements, to geopolitical events and to the market's overall expectations." },
      { q: "What is leverage?", a: "Leverage lets you hold a larger position with a small margin. It magnifies losses as much as gains and can cost you the whole amount you deposited, so it has to be used with care." },
      { q: "What do forex indicators do?", a: "Indicators process price and volume data to help you read market tendencies. They give no certain answer; they are one of several inputs to a decision." },
      { q: "What is a forex broker?", a: "A broker is the intermediary that gives individual and institutional traders access to the forex market. Choosing one is entirely your decision; always check whether the firm is supervised by a competent authority in your country. NUUK compares six regulated partner brokers on its brokers page." },
      { q: "What is a pip?", a: "A pip is the smallest standard price move of a currency pair. It is used to measure the spread between bid and ask, to calculate trading costs and to track profit and loss." },
      { q: "What is a forex strategy?", a: "A strategy is the set of rules that decides when you enter a trade and when you leave it. A good strategy also defines when you do not trade, and includes risk management." },
      { q: "How do I start trading forex?", a: "Learn how the market works first, then practise on a demo account before committing real money. Along the way you can join our free WhatsApp channel to follow the daily signals and market commentary." },
      { q: "How much should I invest?", a: "That depends entirely on your financial situation, risk tolerance, experience and goals. Because we do not give investment advice, we cannot suggest an amount. The general rule stands: never trade with money you cannot afford to lose." },
      { q: "Do I have to follow the signals?", a: "No. Every member is free to assess the market with their own analysis and to open their own trades. The signals exist to support that process and save time; the decision is always yours." },
      { q: "Is forex risky?", a: "Yes. Forex carries a high risk of loss and a large share of retail traders lose money. There is no such thing as a guaranteed result, and past performance is not an indicator of the future. We share signals, analysis and education to help you make your own decision; the outcome always depends on your choices, your risk management and market conditions." },
    ],
    closingTitle: "Smarter trading is waiting for you",
    closingBody: "Join the free NUUK WhatsApp channel and follow the AI signals with the reasoning attached.",
    closingCta: "Start now",
    riskTitle: "Risk warning",
    riskBody: "Forex and CFD trading carries a serious risk of loss and is not suitable for every investor. You could lose all of your deposited capital. The signals, analysis and educational content shared by NUUK are general market commentary; they are not personal investment advice and do not take your circumstances into account. Past performance is not an indicator of future results. Trade only with money you can afford to lose.",
  },
  ...
  legal: {
    ...
    privacy: {
      ...
      body: [
        ...
        "Cookies and visitor analytics. Google Analytics may set cookies to distinguish sessions. Apollo.io records page visits and, where the visit comes from a business network, may identify the company behind the IP address; Apollo also enriches business email addresses entered into our forms with publicly available company data. We use the Meta Pixel to measure our ads: it sends page views and clicks to our WhatsApp channel to Meta Platforms (Facebook/Instagram), which processes them under its own privacy policy and may store them outside your country. All of these may set cookies. Third-party sites you open from our links (brokers, Telegram, social networks) apply their own policies. Live market quotes on this site are embedded TradingView widgets, which load from TradingView's servers and may set their own cookies under TradingView's privacy policy. You can block all of these with a browser extension or by disabling third-party scripts; the site works without them.",
