...
export default function EventCard({ e, c }: { e: Event; c: SiteContent }) {
  ...
  return (
    <article className="rv grid gap-6 rounded-xl bg-white p-6 ring-1 ring-black/5 shadow-card lg:grid-cols-12 lg:items-center">
      <div className="flex items-center gap-4 lg:col-span-3">
        <span className="flex size-12 flex-none items-center justify-center rounded-md bg-paper text-primary">
      ...
      <div className="lg:col-span-2 lg:text-end">
        <Button href={e.href} className="py-3">
          {L.register}
        </Button>
      </div>
    </article>
